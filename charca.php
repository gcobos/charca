...
function watchRestart () {
	...
	timer = setTimeout('overlay.onclick = handleClick; canvas.onmousemove = handleMouseMove; canvas.onclick = handleClick; canvas.ondblclick = null', wait);
}
...
<body onload="init('stageCanvas', 'canvasWrapper','canvasOverlay')"> <!-- bgcolor="#769083">-->
   ...
   if (d.getElementById(id)) return;
	...
	<?php if (in_array($_SERVER['HTTP_HOST']=='localhost' || $_SESSION['fb_user_id'],array('1236628420','752565913'))): ?><input id="wlevel" type="text" value="0" /><?php endif; ?>
	<div id="canvasWrapper" align="center" style="width: 640px; height: 480px">
		...
		<fb:like href="https://apps.facebook.com/htmlgame_charca" send="false" width="640" show_faces="false" font="trebuchet ms"></fb:like>		
	</div>
</body>
</html>
